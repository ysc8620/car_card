	...
	<table width="100%" class="table_form">
	    ...
	    <tr>
			...
			<td>
				...
				<?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($img_dir); echo ($info["img"]); ?>"><img src="__STATIC__/images/filetype/image_s.gif" /></span><?php endif; ?>
            </td>
		</tr>
        <tr>
			<th>会员邮箱 :</th>
		...
		<tr>
			<th>出生日期 :</th>
			<td><input type="text" name="birthday" id="birthday" class="date input-text" value="<?php echo ($info["birthday"]); ?>" size="27"></td>
		</tr>
		<tr>
        	<th>性别 :</th>
            <td>
